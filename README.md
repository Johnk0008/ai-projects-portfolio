...
# 📦 **Newly Added Projects (14–53)** **Newly Added Projects (14–53)**

### [14. Genetic Engineering Project](/14-genetic_engineering_project/)

A conceptual/simulated project exploring computational genetic engineering workflows.

### [15. Simple Storage Smart Contract](/15-Simple%20Storage%20Smart%20Contract/)

A basic Solidity smart contract demonstrating storage operations.

### [16. Polling System Smart Contract](/16-Polling%20System%20Smart%20Contract/)

A blockchain-based decentralized polling/voting smart contract.

### [17. Basic Calculator Program](/17-Basic_Calculator%20Program/)

A simple arithmetic calculator program.

### [18. Banking System (Mini Project)](/18-Banking%20System/)

A mini banking system offering account operations.

### [19. CGPA Calculator](/19-CGPA%20Calculator/)

A tool to calculate CGPA using subject grades and credit scores.

### [20. Login & Registration System](/20-Login%20and%20Registration%20System/)

A secure authentication module with user registration and login.

### [21. Detecting Data Leaks Using SQL Injection](/21-Detecting%20Data%20Leaks%20Using%20SQL%20Injection/)

A security project demonstrating SQL injection vulnerabilities and prevention.

### [22. Cloud-Based Bus Pass System](/22-Cloud-Based%20Bus%20Pass%20System/)

A cloud app for bus pass application, renewal, and management.

### [23. Network Sniffer](/23-network_sniffer/)

Packet capturing and network traffic analysis tool.

### [24. Phishing Awareness Training](/24-phishing_awareness_training/)

Cybersecurity project teaching phishing patterns and defense strategies.

### [25. Web Scraping Project](/25-web_scraping_project/)

Automated scripts for scraping structured web data.

### [26. Data Visualization Project](/26-data-visualization-project/)

Visual data analytics using Python visualization libraries.

### [27. Iris Flower Classification](/27-Iris%20Flower%20Classification/)

A supervised ML classification model using the Iris dataset.

### [28. Unemployment Analysis with Python](/28-Unemployment%20Analysis%20with%20Python/)

Data analysis and visualization of unemployment trends.

### [29. 3D Modeling Visualization](/29-3d_modeling_visualization/)

3D object modeling and visualization.

### [30. Earthquake-Resistant Design](/30-earthquake_resistant_design/)

Civil engineering simulation/concept for earthquake-safe structures.

### [31. ML CI/CD Pipeline](/31-ml-cicd-pipeline/)

End-to-end ML automation using CI/CD tools.

### [32. Jenkins Remoting Project](/32-jenkins-remoting-project/)

Automation using Jenkins remoting API.

### [33. Music Player using JavaScript](/33-Music%20Player%20using%20JavaScript/)

Web-based audio player with interactive UI.

### [34. Image Gallery](/34-Image%20Gallery/)

Responsive and dynamic image gallery web project.

### [35. E-commerce Store](/35-ecommerce_store/)

A mini online shopping platform.

### [36. Social Media Platform](/36-social_media_platform/)

Prototype social platform supporting posts, likes, and user profiles.

### [37. Logo Redesign AI](/37-logo-redesign-ai/)

AI-driven logo redesign and generation system.

### [38. Student Grade Tracker](/38-StudentGradeTracker/)

Tool to manage, track, and visualize student grades.

### [39. AI Chatbot Project](/39-ai-chatbot-project/)

Conversational AI chatbot powered by NLP models.

### [40. Credit Scoring Model](/40-credit-scoring-model/)

ML model predicting user creditworthiness.

### [41. Disease Prediction System](/41-disease_prediction/)

AI model predicting diseases based on input features.

### [42. 3D CAD Python Project](/42-3d-cad-python/)

CAD modeling automated with Python scripts.

### [43. FEA Project](/43-fea_project/)

Finite Element Analysis simulations.

### [44. Financial Health Dashboard](/44-financial-health-dashboard/)

Dashboard analyzing financial KPIs.

### [45. HR Analytics Dashboard](/45-hr-analytics-dashboard/)

Employee performance and attrition analysis dashboard.

### [46. Hangman Game](/46-hangman-game/)

Classic Hangman game built with Python/JavaScript.

### [47. Stock Portfolio Tracker](/47-stock-portfolio-tracker/)

Tracks investment portfolio performance and analytics.

### [48. FBI Crime Forecasting](/48-fbi_crime_forecasting/)

Predictive analytics on FBI crime datasets.

### [49. Strava Fitness Analysis](/49-Strava_Fitness_Analysis/)

Analysis of Strava activity and fitness datasets.

### [50. Property Price Prediction](/50-Property_Price%20_Prediction/)

ML model predicting real estate prices.

### [51. Customer Churn Prediction](/51-Customer%20Churn%20Prediction/)

Predictive churn analytics model.

### [52. Early Disease Detection](/52-Early_Disease_Detection/)
